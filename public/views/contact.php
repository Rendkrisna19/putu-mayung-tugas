                ...
                <div class="flex flex-wrap">
                    <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                        <form>
                            ...
                            <button type="button"
                                class="mb-6 w-full rounded bg-indigo-600 text-white px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal lg:mb-0">
                                Send
                            </button>
                        </form>
                    </div>
                        ...
                        <div class="flex flex-wrap">
                            <div
                                ...
                                <div class="flex items-start">
                                    <div class="shrink-0">
                                        <div class="inline-block rounded-md bg-indigo-600 p-4 text-primary">
                            ...
                            <div
                                ...
                                <div class="align-start flex">
                                    ...
                                    <div class="ml-6 grow">
                                        ...
                                        <p class="text-neutral-500">082275373233
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div
                                ...
                                <div class="align-start flex">
                                    ...
                                    <div class="ml-6 grow">
                                        ...
                                        <p class="text-neutral-500"> 082743732332
                                        </p>
                                    </div>
                                </div>
                            </div>
